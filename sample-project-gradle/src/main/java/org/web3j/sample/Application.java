...
import org.web3j.sample.contracts.generated.MyToken;
...
public class Application {
    ...
    private void run() throws Exception {
        ...
        /*        // Lets modify the value in our smart contract
        TransactionReceipt transactionReceipt2 = contract2.newGreeting("Well hello again").send();
        ...
        // For Strings and arrays, the hash of values is provided, not the original value.
        // For further information, refer to https://docs.web3j.io/filters.html#filters-and-events
        for (MyFirstToken.TRANSFER_EVENTModifiedEventResponse event : contract2.getModifiedEvents(transactionReceipt2)) {
            log.info("Modify event fired, previous value: " + event.oldGreeting
                    + ", new value: " + event.newGreeting);
            log.info("Indexed event previous value: " + Numeric.toHexString(event.oldGreetingIdx)
                    + ", new value: " + Numeric.toHexString(event.newGreetingIdx));*/
